...
class CommandTest extends TestCase
{
    ...
    {
        Artisan::call('permission:create-role', ['name' => 'new-role', 'guard' => 'api']);
    ...
    {
        Artisan::call('permission:create-permission', ['name' => 'new-permission', 'guard' => 'api']);
    ...
    {
        Artisan::call('permission:create-role', ['name' => 'new-role', 'permissions' => 'first permission | second permission']);
