...
class HasPermissionsTest extends TestCase
{
    ...
    public function it_can_determine_that_user_has_direct_permission()
    {
        ...
        $this->assertEquals(collect(['edit-articles']), $this->testUser->getDirectPermissions()->pluck('name'));
        $this->testUser->revokePermissionTo('edit-articles');
    ...
    public function it_can_list_all_the_permissions_via_roles_of_user()
    {
        ...
        $this->assertEquals(collect(['edit-articles', 'edit-news']), $this->testUser->getPermissionsViaRoles()->pluck('name'));
    }
    /** @test */
    public function it_can_list_all_the_coupled_permissions_both_directly_and_via_roles()
    {
        ...
        $this->testUserRole->givePermissionTo('edit-articles');
        $this->testUser->assignRole('testRole');
        $this->assertEquals(collect(['edit-articles', 'edit-news']), $this->testUser->getAllPermissions()->pluck('name'));
    }
    /** @test */
